(function () {
  ...
  // MP reference data IDs — confirm with your MP administrator if records aren't saving correctly
  ...
  function resetWidget() {
    ...
    // Rebuild children section with a single blank card
    document.getElementById("children-container").innerHTML = "";
    addChildCard();
    updateAddChildBtn();
    hideError("step1-error");

    // Reset group assignment area
